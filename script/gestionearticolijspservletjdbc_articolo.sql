...
CREATE TABLE `articolo` (
  ...
  CONSTRAINT `id_categoria_fk` FOREIGN KEY (`id_categoria_fk`) REFERENCES `categoria` (`id_categoria`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `articolo` VALUES (1,'A1FM','nuovo',59,1),(2,'A2DR','usato',56,2),(3,'B1GT','ricondizionato',35,1),(5,'CVCV','bello',23,2);
...
-- Dump completed on 2020-11-12 10:02:59

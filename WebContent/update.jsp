					...
					<form method="post" action="ExecuteUpdateArticoloServlet" novalidate="novalidate">
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="text" name="codice" id="codice" class="form-control" value="${requestScope.codice}" required>
							</div>
							
							<div class="form-group col-md-6">
								<label>Descrizione <span class="text-danger">*</span></label>
								<input type="text" name="descrizione" id="descrizione" class="form-control" value="${requestScope.descrizione}" required>
							</div>
						
							<div class="form-group col-md-3">
								<label>Prezzo <span class="text-danger">*</span></label>
								<input type="number" class="form-control" name="prezzo" id="prezzo" value="${requestScope.prezzo}" required>
							</div>
